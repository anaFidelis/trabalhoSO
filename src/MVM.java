...
public class MVM {
    ...
    /*
        Flags:
        bit zero representa -> 0 = interrupçoes desabilitadas
                            -> 1 = interrupçoes habilitadas
        bit um representa   -> 0 = sigle-step desabilitado
                            -> 1 = single-step habilitado
    */
    ...
    public static void decodificador(short mem[], int programa, int aux, ArrayList<String> arrayInstrucoes) {
        ...
        while (repetir) {
            ...
            switch (ri) {
                ...
                case 55://"pushf"
                    tela.appendLog(ip+" - Executou pushf");
                    mem[sp] = (short) flag;
                    sp--;
                    acessosMemoria++;                    
                    acessosMemoria++;
    ...
    public static void codificador(short mem[], /*String sArquivo,*/ short shPosicao, ArrayList<String> arrayInstrucoes) throws FileNotFoundException, IOException {
        ...
        for(String sInstrucao : arrayInstrucoes) {
            ...
            if (sConteudo.equals("initax")){// "init ax"
                ...
                mem[iMem++] = 53;
                //acessosMemoria++;
            }else if(sConteudo.contains("pushf")){
                mem[iMem++] = 55;
